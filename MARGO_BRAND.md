...
- **4.9 (Aug 2026):** Landing typography pass — Lora for lyric/hero voice only; Geist for chrome/meta/CTA. Hero clamp capped. Exchange lyric at Lyric star `1.1rem`. How-it-works stacks on mobile with Secondary/Body (no Micro body). Ticker/nav chrome to Geist.
