...
*Version 4.5 — August 2026 — Living document, update with every design decision*
...
- Letter-spacing is fixed at **5px** (not 3px)
...
- 1.5rem 600                  — Modal headers, account page titles
- 1.25rem 600                 — Profile display name
- 1.15rem 600                 — Card titles, song names (stacked metadata)
- 1.1rem 400 italic **Lora**  — Lyric text (the star, never change face here)
- 0.95rem 400                 — Body text, descriptions
- 0.82rem 400                 — Secondary text
- 0.75rem 400                 — Artist names (under song title); nav links use 0.75rem 700 uppercase
- 0.7rem 400                  — Timestamps, counts, **@usernames**
- 0.6rem 600                  — Labels, vibe tags, uppercase UI / CTA labels
- MINIMUM / TYPE FLOOR: 0.6rem — nothing smaller on user-facing UI, ever (badges may use 0.6rem floor; never invent 0.42–0.58)

> **Note:** Interactive control text is governed by Section 14 Rule 3 as refined by Section 15 — short CTAs stay `0.6–0.7rem` with ≥44px touch targets.
