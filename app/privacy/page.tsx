      ...
      <div style={{ minHeight: '100vh', background: 'var(--bg)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '680px', margin: '0 auto', padding: '88px 24px 120px', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ fontFamily: font, fontSize: '0.95rem', lineHeight: 1.75, color: 'var(--text-2)' }}>
            ...
            <p style={pStyle}><strong style={{ color: 'var(--text)', fontWeight: 600 }}>Session cookie.</strong> When you sign in, Margo sets a session cookie, including authentication-related session information, so we can keep you authenticated. The cookie is HttpOnly, which means it cannot be read by JavaScript running in your browser, and is scoped to trymargo.com. It is not used for advertising or cross-site tracking.</p>
