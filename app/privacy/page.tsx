      ...
      <div style={{ minHeight: '100vh', background: 'var(--bg)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '680px', margin: '0 auto', padding: '88px 24px 120px', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ fontFamily: 'var(--font-lora), serif', fontSize: '0.95rem', lineHeight: 1.75, color: 'var(--text-2)' }}>
            ...
            <p style={{ marginBottom: '1.4em' }}>YouTube metadata attached to a post is stored in our database alongside the post itself. It is deleted when the post is deleted. We do not cache or retain YouTube data beyond its association with an active post.</p>
            ...
            <p style={{ marginBottom: '1.4em' }}>Margo hosts original music created and owned by Margo, licensed for use on the platform and on all major streaming services. No personal data is collected when you interact with it.</p>
            ...
            <p style={{ marginBottom: '1.4em' }}>Margo is evolving. As the platform grows, so may the way we handle data. We will update this policy before any material changes go live. We encourage you to check back here periodically — continued use of Margo constitutes acceptance of any updates.</p>
