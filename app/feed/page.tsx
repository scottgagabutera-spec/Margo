    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', position: 'relative' }}>
      ...
      <div style={{ position: 'sticky', top: '56px', zIndex: 30, background: 'var(--bg)', padding: '56px 20px 0' }}>
        <div style={{ maxWidth: '720px', margin: '0 auto' }}>
          ...
          <div style={{ position: 'relative', paddingBottom: '24px', paddingTop: '6px' }}>
            <input
      ...
      <main style={{ position: 'relative', zIndex: 5, maxWidth: '720px', margin: '0 auto', padding: '40px 24px var(--margo-page-padding-bottom)' }}>
        {loading && (
