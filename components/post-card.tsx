...
export function PostCard({
  ...
  // Experimental swipe panels — feed only; kill via NEXT_PUBLIC_POST_CARD_PANELS=0
  const usePanels = POST_CARD_PANELS_ENABLED && variant === 'feed'
