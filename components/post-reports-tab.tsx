  ...
  return (
    <div>
      <p style={{ fontFamily: font, fontSize: '0.82rem', color: 'var(--text-secondary)', marginBottom: '20px', lineHeight: 1.5 }}>
        User-filed reports from the PostCard menu. Mark reviewed when handled; dismiss false positives.
        ...
        reports.map(r => (
          <div key={r.id} style={S.card}>
            ...
            <p style={{ fontFamily: font, fontStyle: 'italic', fontSize: '0.95rem', color: 'var(--text)', marginBottom: '8px', lineHeight: 1.45 }}>
              &ldquo;{r.postText || '—'}&rdquo;
            </p>
            {(r.song || r.artist) && (
              <p style={{ fontFamily: font, fontSize: '0.6rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '8px' }}>
