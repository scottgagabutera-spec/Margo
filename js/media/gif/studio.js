...
function stWatermark(ctx, W, H, {acc:theme.accent,light:theme.text==="#000000"}) {
  ctx.save();
...
function gsDrawFrame(ctx, W, H, t, post) {
  ...
  stWordmark(ctx, W, H, {acc:theme.accent,light:theme.text==="#000000"});
  ...
  stMmark(ctx, W, H, {acc:theme.accent,light:theme.text==="#000000"});
}
