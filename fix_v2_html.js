...
const newHTML = [
'          <div class="smart-search-wrap" id="echoSmartSearchWrap">',
...
'              <input id="echoSmartInput" type="text" inputmode="text" autocomplete="off" autocorrect="off" spellcheck="false" class="smart-search-input" placeholder="Search by lyric, song or artist…"/>',
...
// Replace lines 361-371 (0-indexed 360-370)
lines.splice(360, 11, ...newHTML);
